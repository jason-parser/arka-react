  ...
  handleService(event) {
    ...
    if (!this.state.filters.services.includes(name)) {
      ...
      this.setState(prevState => ({
        ...
        filters: {
          ...prevState.filters,
          services: prevState.filters.services.filter(
            ...
            <div className="booking">
              <div className="booking__block" id="from">
                ...
                <div className="booking__inputs">
                  <p className="booking__value" id="check-in">
                    {this.state.checkIn.format('D')}
                  </p>
                  <div className="booking__controls">
                    <span>
                      {this.state.checkIn.format('MMM').substring(0, 3)}
                    </span>
                    <img src="/wp-content/themes/hotelbooking/img/rooms-page/arrow-down.svg" />
                  </div>
                </div>
              ...
              <div className="booking__block" id="to">
                ...
                <div className="booking__inputs">
                  <p className="booking__value" id="check-out">
                    {this.state.checkOut.format('D')}
                  </p>
                  <div className="booking__controls">
                    <span>
                      {this.state.checkOut.format('MMM').substring(0, 3)}
                    </span>
                    <img src="/wp-content/themes/hotelbooking/img/rooms-page/arrow-down.svg" />
                  </div>
                </div>
              ...
              <div className="booking__block">
                ...
                <div className="booking__inputs">
                  <p className="booking__value" id="guests">
                    {this.state.guests}
                  </p>
                  <div className="booking__controls">
                    <img
              ...
              <div className="booking__block">
                ...
                <div className="booking__inputs">
                  <p className="booking__value" id="nights">
                    {this.state.checkOut.diff(this.state.checkIn, 'days')}
                  </p>
                </div>
              </div>
              ...
              <div className="booking__block">
                ...
                <div className="booking__inputs">
                  <p className="booking__value" id="children">
                    {this.state.children}
                  </p>
                  <div className="booking__controls">
                    <img
              ...
              <div className="booking__block">
                ...
                <div className="booking__inputs">
                  <p className="booking__value" id="rooms">
