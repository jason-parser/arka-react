  ...
  <form>
    <div className="filters__input-group">
      <input
        ...
        value={filters.services.includes('free-wifi')}
      />
    ...
    <div className="filters__input-group">
      <input
        ...
        id="digital-tv"
        onChange={handleService}
        value={filters.services.includes('digital-tv')}
      />
    ...
    <div className="filters__input-group">
      <input
        ...
        id="climate"
        onChange={handleService}
        value={filters.services.includes('climate')}
      />
    ...
    <div className="filters__input-group">
      <input
        ...
        id="work"
        onChange={handleService}
        value={filters.services.includes('work')}
      />
    ...
    <div className="filters__input-group">
      <input
        ...
        id="bath"
        onChange={handleService}
        value={filters.services.includes('bath')}
      />
    ...
    <div className="filters__input-group">
      <input
        ...
        id="shower"
        onChange={handleService}
        value={filters.services.includes('shower')}
      />
    ...
    <div className="filters__input-group">
      <input
        ...
        id="safe"
        onChange={handleService}
        value={filters.services.includes('safe')}
      />
    ...
    <div className="filters__input-group">
      <input
        ...
        id="pillows"
        onChange={handleService}
        value={filters.services.includes('pillows')}
      />
    ...
    <div className="filters__input-group">
      <input
        ...
        id="coffee"
        onChange={handleService}
        value={filters.services.includes('coffee')}
      />
    ...
    <div className="filters__input-group">
      <input
        ...
        id="tea"
        onChange={handleService}
        value={filters.services.includes('tea')}
      />
    ...
    <div className="filters__input-group">
      <input
        ...
        id="bar"
        onChange={handleService}
        value={filters.services.includes('bar')}
      />
    ...
    <div className="filters__input-group">
      <input
        ...
        id="bast"
        onChange={handleService}
        value={filters.services.includes('bast')}
      />
    ...
    <div className="filters__input-group">
      <input
        ...
        id="dryer"
        onChange={handleService}
        value={filters.services.includes('dryer')}
      />
    ...
    <div className="filters__input-group">
      <input
        ...
        id="robe"
        onChange={handleService}
        value={filters.services.includes('robe')}
      />
    ...
    <div className="filters__input-group">
      <input
        ...
        id="view"
        onChange={handleService}
        value={filters.services.includes('view')}
      />
    ...
    <div className="filters__input-group">
      <input
        ...
        id="parking"
        onChange={handleService}
        value={filters.services.includes('parking')}
      />
